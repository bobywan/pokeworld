  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        {/* En-tête */}
        <div className="sticky top-0 flex items-center justify-between border-b border-surface-border bg-surface px-5 py-4 rounded-t-card">
        ...
        <div className="space-y-6 px-5 py-5">
          ...
          <p className="text-xs text-text-secondary leading-relaxed">
            La barre de recherche comprend <strong>plusieurs mots simultanément</strong> — chaque mot est un filtre supplémentaire (logique ET). Vous pouvez combiner texte et opérateurs numériques librement.
          </p>
